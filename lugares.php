...
<!-- Menu principal -->
 ...
 <div class="ui four column doubling stackable grid container">
  <div class="column">
      <a href="lugares11.php?cat=Cultura"><i class="blue massive book icon"></i></a>
    <h4>Cultura</h4>
  </div>
  <div class="column">
      <a href="lugares11.php?cat=Restaurante"><i class="blue massive food icon"></i></a>
    <h4>Alimentos</h4>
  </div>
  <div class="column">
      <a href="lugares11.php?cat=Bar"><i class="blue massive bar icon"></i></a>
    <h4>Bares</h4>
  </div>
  <div class="column">
    <a href="lugares11.php?cat=Entretenimiento"><i class="blue massive film icon"></i></a>
    <h4>Entrenimiento</h4>
  </div>
</div>
<div class="ui four column doubling stackable grid container">
  <div class="column">
      <a href="lugares11.php?cat=Parque"><i class="blue massive tree icon"></i></a>
    <h4>Parques</h4>
  </div>
  <div class="column">
      <a href="lugares11.php?cat=Hotel"><i class="blue massive h icon"></i></a>
    <h4>Hoteles</h4>
  </div>
  <div class="column">
      <a href="lugares11.php?cat=Cafeteria"><i class="blue massive coffee icon"></i></a>
    <h4>Cafeterias</h4>
  </div>
  <div class="column">
      <a href="lugares11.php?cat=Club Nocturno"><i class="blue massive cocktail icon"></i></a>
    <h4>Clubes Nocturnos</h4>
  </div>
</div>
<div class="ui four column doubling stackable grid container">
  <div class="column">
      <a href="lugares11.php?cat=Monumento"><i class="blue massive university icon"></i></a>
    <h4>Monumentos</h4><br>
    </div>
</div>
